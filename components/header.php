...
<html lang="en">
  ...
  <body>
    ...
    <?php
    $totalItems = isset($_SESSION['finalCart']) ? count($_SESSION['finalCart']) : 0;
...
<div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart" aria-labelledby="My Cart">
    ...
    <?php if ($totalItems > 0): ?>
        <?php foreach ($_SESSION['finalCart'] as $index => $item): ?>
            <li class="list-group-item d-flex justify-content-between lh-sm">
                <div>
                    <h6 class="my-0"><?php echo htmlspecialchars($item['p_name']); ?></h6>
                </div>
                <span class="text-body-secondary">$<?php echo $item['p_price']* $item['p_qty']; ?></span>
                <div class="quantity-control">
                    <form method="POST" action="">
                        <input type="hidden" name="item_id" value="<?php echo $item['p_id']; ?>">
                        <button type="submit" name="decrease" class="btn btn-outline-secondary btn-sm">-</button>
                        <span><?php echo $item['p_qty']; ?></span>
                        <button type="submit" name="increase" class="btn btn-outline-secondary btn-sm">+</button>
                    </form>
                </div>
                <a href="?remove=<?php echo $item['p_id']?>" class="btn btn-danger">Remove</a>
            </li>
        <?php endforeach; ?>
...
?>
    <button class="w-100 btn btn-primary btn-lg" type="button" onclick="location.href='?checkout'">Continue to checkout</button>
<?php 
} else {
?>
    <button class="w-100 btn btn-primary btn-lg" type="button" onclick="location.href='login.php'">Continue to checkout</button>
<?php 
}
?>
           ...
           <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            ...
            <div class="cart text-end d-none d-lg-block dropdown">
              <button class="border-0 bg-transparent d-flex flex-column gap-2 lh-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                ...
                <span class="cart-total fs-5 fw-bold">$<?php echo number_format($totalPrice, 2); ?></span>
              </button>
            </div>
          </div>
      ...
      <div class="container-fluid">
        <div class="row py-3">
          <div class="d-flex  justify-content-center justify-content-sm-between align-items-center">
            <nav class="main-menu d-flex navbar sticky-top navbar-expand-lg">
...
<select class="filter-categories border-0 mb-0 me-5">
    ...
    <?php
    // Replace $pdo with your actual PDO database connection variable
                  ...
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    ...
                    <?php
							if(isset($_SESSION['userEmail'])){
								?>
								<li>
							 <a href="weblogout.php" class="nav-link">Logout</a>
							</li>
							<?php
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="pages">
                        ...
                        <li><a href="#arrivebrands" class="dropdown-item">Arrive Brands </a></li>
